...
angular.module('bank').factory('UserService',
    ['$localStorage', '$http', '$q', 'urls',
        function ($localStorage, $http, $q, urls) {
            ...
            function loadAllUsers() {
                ...
                $http.get("http://localhost:8080/bank/api/v1/users/")
                    .then(
                        function (response) {
            ...
            function createUser(users) {
                ...
                var deferred = $q.defer();
                $http.post("http://localhost:8080/bank/api/v1/users/", users)
                    .then(
                        function (response) {
                            loadAllUsers();
                            deferred.resolve(response.data);
            ...
            function updateUser(users, id) {
                ...
                var deferred = $q.defer();
                $http.put("http://localhost:8080/bank/api/v1/users/", users)
                    .then(
                        function (response) {
                            loadAllUsers();
                            deferred.resolve(response.data);
            ...
            function removeUser(id) {
                ...
                var deferred = $q.defer();
                $http.delete("http://localhost:8080/bank/api/v1/users/" + id)
                    .then(
                        function (response) {
                            loadAllUsers();
                            deferred.resolve(response.data);
